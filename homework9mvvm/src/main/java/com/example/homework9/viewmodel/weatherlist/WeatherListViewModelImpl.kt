...
import com.example.homework9.presentation.citieslist.weatherlist.WeatherDataViewListMapper
...
class WeatherListViewModelImpl(
    ...
    private val mutableWeatherListLieData = MutableLiveData<List<WeatherDataView>>()
    val weatherListLiveData = mutableWeatherListLieData
